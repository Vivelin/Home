        ...
        public async Task SeedAsync()
        {
            ...
            if (!hasQuotes)
            {
                ...
                Quotes.Add(new Quote
                {
                    ...
                    Citation = "Age of Mythology, <a href='https://youtu.be/-EvhQcmNORo?t=85' target='_blank' rel='external'>taunt 37</a>"
                });
                ...
                Quotes.Add(new Quote
                {
                    ...
                    Citation = "Sean Plott, <a href='https://youtu.be/CdLnuGAPNUg?t=195' target='_blank' rel='external'>Day[9] Story Time #5 - A High School Crush</a>"
                });
